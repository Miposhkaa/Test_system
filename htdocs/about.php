...
<div class="container">
  <div class="card-deck mb-3 text-center">
    ...
    <div class="card mb-4 shadow-sm">
      <div class="card-header">
        <h4 class="my-0 font-weight-normal">Павел Разиньков</h4>
      </div>
      <div class="card-body">
        <h1 class="card-title pricing-card-title"><img src="f10ZcUOe-Ws.jpg" width="350" height="500"></small></h1>
        <ul class="list-unstyled mt-3 mb-4">
          <li><a href="https://vk.com/pavelrznkv7">Паша</a></li>
...
<p class="lead">Расскажем немного о себе. Мы молодые перспективные программисты. Учимся в Воронежском государственном университете, на Факультете компьютерных наук.
