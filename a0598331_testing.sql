...
--
-- Host: localhost    Database: a0598331_testing
-- ------------------------------------------------------
...
CREATE TABLE `answers` (
  ...
  `correct_answer` enum('0','1') CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `questions` (
  ...
  `parent_test` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `test` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `test_name` varchar(255) CHARACTER SET utf8 NOT NULL,
  `enable` enum('0','1') CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'a0598331_testing'
--
...
-- Dump completed on 2021-11-10  5:09:28
